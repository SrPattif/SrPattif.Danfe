...
namespace DanfeSharp
{
    internal class IdentificacaoEmitente : ElementoBase
    {
        ...
        public override void Draw(Gfx gfx)
        {
            ...
            Graphics.Font f2 = Estilo.CriarFonteNegrito(12);
            Graphics.Font f3 = Estilo.CriarFonteRegular(8);

            if (Logo == null)
            {
                var f1 = Estilo.CriarFonteRegular(6);
                gfx.DrawString("IDENTIFICAÇÃO DO EMITENTE", rp, f1, HorizontalAlignment.Center);
                rp = rp.CutTop(f1.LineHeight);                          
            }
            else
            {
                RectangleF rLogo;
            ...
            ts.AlinhamentoHorizontal = HorizontalAlignment.Center;
            ts.AlinhamentoVertical = VerticalAlignment.Center;
            ts.Draw(gfx);
