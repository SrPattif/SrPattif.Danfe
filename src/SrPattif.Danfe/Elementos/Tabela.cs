...
namespace DanfeSharp
{
    internal class Tabela : ElementoBase
    {
        ...
        public Graphics.Font FonteCorpo { get; private set; }
        public Graphics.Font FonteCabecalho { get; private set; }
        ...
        public Tabela ComColuna(float larguraP, HorizontalAlignment ah, params String[] cabecalho)
        {
        ...
        private Boolean DesenharLinha(Gfx gfx)
        {
            ...
            { 
             ...
             _DY += Math.Max(tbm, FonteCorpo.LineHeight) + PaddingSuperior + PaddingInferior;
        ...
        public void DesenharCabecalho(Gfx gfx)
        {
            ...
            float ac = ml * FonteCabecalho.LineHeight + 2F;
            ...
            foreach (var coluna in Colunas)
            {
                ...
                tb.AlinhamentoVertical = VerticalAlignment.Center;
                tb.AlinhamentoHorizontal = HorizontalAlignment.Center;
