...
namespace DanfeSharp
{
    ...
    internal class TextBlock : DrawableBase
    {
        ...
        public Graphics.Font Fonte { get; private set; }
        ...
        public override void Draw(Gfx gfx)
        {
            ...
            {
                gfx.DrawString(item, new RectangleF(X, y, Width, _Height.Value), Fonte, AlinhamentoHorizontal, VerticalAlignment.Top);
                y += Fonte.LineHeight;
            }
        }
        ...
        private void CalculateLines()
        {
            ...
            _Height = Lines.Count * Fonte.LineHeight;
        }
        ...
        public TextBlock(String text, Graphics.Font f)
        {
            Text = text;
            Fonte = f;
