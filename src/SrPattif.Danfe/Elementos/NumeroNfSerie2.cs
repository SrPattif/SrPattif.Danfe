...
namespace DanfeSharp
{
    class NumeroNfSerie2 : ElementoBase
    {
        ...
        public override void Draw(Gfx gfx)
        {
            ...
            float paddingHorizontal = ViewModel.Orientacao == Orientation.Portrait ? 2.5F : 5F;

            var rp1 = BoundingBox.InflatedRetangle(1F, 0.5F, paddingHorizontal);
            var rp2 = rp1;

            var f1 = Estilo.CriarFonteNegrito(12);
            var f1h = f1.LineHeight;
            gfx.DrawString("DANFE", rp2, f1, HorizontalAlignment.Center);

            rp2 = rp2.CutTop(f1h + 0.5F);

            var f2 = Estilo.CriarFonteRegular(8F);
            var f2h = (float)f2.LineHeight;
            ...
            gfx.DrawString(ViewModel.TipoNF.ToString(), rectEs, Estilo.FonteNumeroFolhas, HorizontalAlignment.Center, VerticalAlignment.Center);


            var f4 = Estilo.FonteNumeroFolhas;
            var f4h = Estilo.FonteNumeroFolhas.LineHeight;
            ...
            RetanguloNumeroFolhas = new RectangleF(rp1.Left, rp1.Bottom - Estilo.FonteNumeroFolhas.LineHeight, rp1.Width, Estilo.FonteNumeroFolhas.LineHeight);
        }
    }
}