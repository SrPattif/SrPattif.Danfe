...
namespace DanfeSharp
{
    ...
    {   
        ...
        public CampoMultilinha(String cabecalho, String conteudo, Estilo estilo, HorizontalAlignment alinhamentoHorizontalConteudo = HorizontalAlignment.Left)
        ...
        protected override void DesenharConteudo(Gfx gfx)
        {
            ...
            {
                _tbConteudo.SetPosition(RetanguloDesenhvael.X, RetanguloDesenhvael.Y + Estilo.FonteCampoCabecalho.LineHeight + Estilo.PaddingInferior);
        ...
        public override float Height
        {
            get
            {
                return Math.Max(_tbConteudo.Height + Estilo.FonteCampoCabecalho.LineHeight + Estilo.PaddingSuperior + 2*Estilo.PaddingInferior , base.Height);
            }
            set
            {
                base.Height = value;
